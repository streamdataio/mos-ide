...
public class Images {
	...
	public static final ImageDescriptor motwinMedium = createDescriptor("motwin_medium.png");
	...
	private static ImageRegistry getImageRegistry() {
		MotwinUIPlugin plugin = MotwinUIPlugin.getDefault();
		return plugin == null ? null : plugin.getImageRegistry();
	}

	private static ImageDescriptor doCreateDescriptor(String image) {
		return AbstractUIPlugin.imageDescriptorFromPlugin(MotwinUIPlugin.PLUGIN_ID, "icons/" + image); //$NON-NLS-1$
	}
