package com.motwin.ide.android.cheatsheets.realtimepush.internal;
...
public class RealTimePushCheatSheetPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.motwin.ide.android.cheatsheets.realtimepush"; //$NON-NLS-1$
