 ...
 * 
 */
public final class ShowContextCollectorRegistryAction extends AbstractContextAwareAction {

    @Override
    protected void perform(final IJavaProject aJavaProject) {
        new JavaShowLineActionHelper(this, aJavaProject).showLine("MotwinFacade.java", 380);
