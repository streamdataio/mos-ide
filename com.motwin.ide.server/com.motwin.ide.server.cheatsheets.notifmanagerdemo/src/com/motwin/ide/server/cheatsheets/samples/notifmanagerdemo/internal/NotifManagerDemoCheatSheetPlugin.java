package com.motwin.ide.server.cheatsheets.samples.notifmanagerdemo.internal;
...
public class NotifManagerDemoCheatSheetPlugin extends AbstractUIPlugin {
    ...
    // The plug-in ID
    public static final String                      PLUGIN_ID = "com.motwin.ide.server.cheatsheets.notifmanagerdemo"; //$NON-NLS-1$
