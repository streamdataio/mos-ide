package com.motwin.ide.server.cheatsheets.samples.realtimepush.internal;
...
public class RealTimePushCheatSheetPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.motwin.ide.server.cheatsheets.realtimepush"; //$NON-NLS-1$
