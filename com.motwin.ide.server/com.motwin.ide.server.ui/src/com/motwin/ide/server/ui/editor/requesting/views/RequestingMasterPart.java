...
public class RequestingMasterPart extends AbstractMotwinConfigMasterPart {

    private Button createProcessorButton;

    public RequestingMasterPart(AbstractConfigFormPage page, Composite parent) {
        super(page, parent);
    }

    @Override
    protected String getSectionTitle() {
        return "Motwin Requesting";
    }
