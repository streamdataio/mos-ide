...
public class VirtualdbDetailsPart extends AbstractNamespaceDetailsPart {

	public VirtualdbDetailsPart(AbstractConfigMasterPart master) {
		super(master);
	}

	public VirtualdbDetailsPart(AbstractConfigMasterPart master, String docsUrl) {
	...
	public SpringConfigDetailsSectionPart createDetailsSectionPart(AbstractConfigEditor editor, IDOMElement input,
		...
		return new VirtualdbDetailsSectionPart(editor, input, parent, toolkit);
	}
