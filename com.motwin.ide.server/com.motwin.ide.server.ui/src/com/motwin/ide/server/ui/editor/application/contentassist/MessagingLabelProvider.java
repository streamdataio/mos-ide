...
public class MessagingLabelProvider extends JFaceNodeLabelProvider {
    ...
    public Image getImage(Object aElement) {
        ...
        if (ApplicationNamespaceUtils.PROCESSOR_TAG.equals(elementName)) {
            return ServerImages.MESSAGE_PROCESSOR;
        }
    ...
    public String getText(Object aElement) {
        ...
        if (ApplicationNamespaceUtils.PROCESSOR_TAG.equals(elementName)) {
            return "MessageProcessor:" + type + ":" + ApplicationNamespaceUtils.extractTextRef(node);
        }
