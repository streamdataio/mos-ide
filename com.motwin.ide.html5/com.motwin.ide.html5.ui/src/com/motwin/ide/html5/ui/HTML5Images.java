 ...
 * 
 */
public class HTML5Images {

    private static final Logger         log  = LoggerFactory.getLogger(HTML5Images.class);

    public static final ImageDescriptor LOGO = createDescriptor("motwin_16.png");
    ...
    private static ImageRegistry getImageRegistry() {
        MotwinHTML5UIPlugin plugin = MotwinHTML5UIPlugin.getDefault();
        return plugin == null ? null : plugin.getImageRegistry();
    }

    private static ImageDescriptor doCreateDescriptor(String image) {
        return AbstractUIPlugin.imageDescriptorFromPlugin(MotwinHTML5UIPlugin.PLUGIN_ID, "icons/" + image); //$NON-NLS-1$
    }
