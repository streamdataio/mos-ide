package com.motwin.ide.html5.cheatsheets.samples.helloworld.internal;
...
public class HelloWorldCheatSheetPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.motwin.ide.html5.cheatsheets.helloworld"; //$NON-NLS-1$
