package com.motwin.ide.html5.cheatsheets.samples.rssreader.internal;
...
public class RSSReaderCheatSheetPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.motwin.ide.html5.cheatsheets.rssreader"; //$NON-NLS-1$
